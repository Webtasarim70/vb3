	<div id="sidebar" class="col-md-4">
		...
		<div class="widget wid-follow">
			...
			<div class="content">
				...
				<img src="<?php echo base_url('assets/zKoolTube/'); ?>images/banner.jpg" />
			</div>
			<div class="line"></div>
		</div>
		<!---- Start Widget ---->
			...
			<div class="content">
				...
				<div class="post wrap-vid">
					<div class="zoom-container">
						...
						<img src="<?php echo base_url('assets/zKoolTube/'); ?>images/9.jpg" />
					</div>
					<div class="wrapper">
						<h5 class="vid-name"><a href="#">Video's Name</a></h5>
						<div class="info">
		...
		<div class="widget wid-post">
			...
			<div class="content">
				<div class="post">
					<a href="single.html">
						<img src="<?php echo base_url('assets/zKoolTube/'); ?>images/user.png" />
					</a>
					<div class="wrapper">
		...
		<div class="widget wid-banner">
			<img src="<?php echo base_url('assets/zKoolTube/'); ?>images/banner-2.jpg" />
		</div>
	</div>